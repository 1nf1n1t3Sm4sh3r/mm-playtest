...
1. After installing the userscript manager, click [here](https://raw.githubusercontent.com/1nf1n1t3Sm4sh3r/mm-playtest/main/js/script.user.js) to install **The MegaMod**:
